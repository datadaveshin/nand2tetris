// File name: projects/04/Fillsandbox3.asm
// Method: Continually check the keyboard, and set state variable to white or black if pressed
// This one I copied over for Fill.asm
(START)
